...
גרסה: V7
- תיקון התראות מייל על יצירה/עדכון משימה כדי להשתמש בהגדרות המייל של העובד המשויך, עם יעד מעסיק פר-עובד אם הוגדר.
...
V6:
- התראת מייל אוטומטית בעת יצירת משימה חדשה
- התראת מייל אוטומטית בעת עדכון משימה קיימת
- מסך הגדרות מעודכן עם סימון V6


בדיקות מהירות אחרי העלאה:
1. פתח /health וודא שמופיע version v10
2. בצע Ctrl+F5
3. בדוק חיפוש, סינון, הוספת עדכון, וסוף משמרת.
