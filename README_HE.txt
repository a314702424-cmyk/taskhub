...
V9:
- סינון לפי עובד/תאריך/עדיפות/חיפוש
- הסינון נשמר אחרי כל פעולה עד שלוחצים נקה סינונים
- מייל על יצירת משימה ועל עדכון עם תוכן מלא
- סוף משמרת שולח 2 דוחות
- כפתורי גלילה וחזרה למשימה אחרונה
- בדיקת גרסה: /health מחזיר v9
